...
class ZintSnapStepByStepDescription {
    ...
    constructor(c_description_item, board = null) {
        ...
        // this.backgroundColor =  divStepByStepDescription.style.backgroundColor;
        // this.backgroundColor = window.getComputedStyle(divStepByStepDescription).getPropertyValue("background-color");
        ...
        if (board !== null) {
            ...
            // elSvg.setAttribute("id", board.id_svg);
    ...
    drawAnimated(pathDefinition, attr_specific = ZintSnapStepByStepDescription.PEN_DEFAULT) {
